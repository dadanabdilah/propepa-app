    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="px-4 py-3 border-bottom">
                <h5 class="card-title fw-semibold mb-0">Upload Modul Praktik Berbagi</h5>
            </div>
            <div class="card-body p-4">
                ...
                <form action="<?= site_url('sharing-practices/new-module') ?>" method="POST">
                    <?= csrf_field() ?>
                    ...
                    <div class="mb-4 row align-items-center">
                        ...
                        <div class="col-sm-9">
                            <select name="category_module_id" id="category_module_id" class="form-control">
                                <option value="" selected disabled>-- Pilih --</option>
                                <?php foreach ($categoryModules as $categoryModule) : ?>
                                    <option value="<?= $categoryModule->id ?>"><?= $categoryModule->name ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                    </div>
