...
<?= $this->section('title') ?>
Tambah Data Kategori Referensi
<?= $this->endSection() ?>
    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="px-4 py-3 border-bottom">
                <h5 class="card-title fw-semibold mb-0">Tambah Data Kategori Referensi</h5>
            </div>
            <div class="card-body p-4">
                ...
                <form action="<?= site_url('admin/category-references') ?>" method="POST" enctype="multipart/form-data">
                    <?= csrf_field() ?>
